...
// $extra_button   = '<a href="...">...</a>'; (opsional, tombol aksi)
?>
<div class="mb-10 flex items-start justify-between">
    <div>
        ...
        <?php endif; ?>
        <p class="text-[10px] font-black text-blue-600 uppercase tracking-[0.2em] mb-2 <?php echo !empty($back_link) ? 'mt-4' : ''; ?>">Panel Administrator</p>
        <h2 class="text-[32px] font-black text-gray-900 tracking-tight"><?php echo $page_title ?? ''; ?></h2>
        <?php if (!empty($page_subtitle)) : ?>
            <p class="text-sm text-gray-400 font-medium tracking-tight"><?php echo $page_subtitle; ?></p>
        <?php endif; ?>
    </div>
    <div class="flex items-center gap-4">
        <?php if (!empty($extra_button)) echo $extra_button; ?>
...
<?php unset($page_title, $page_subtitle, $back_link, $extra_button); ?>
