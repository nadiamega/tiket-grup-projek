...
CREATE DATABASE IF NOT EXISTS `proweb`
...
INSERT INTO `events`
(`id`, `nama_event`, `kategori`, `tanggal`, `harga`, `kuota`, `lokasi`, `deskripsi`, `poster`)
VALUES
(
  1,
  'Theater "Born To Die"',
...
(`id`, `nama_sponsor`, `kategori`, `email`, `telp`)
VALUES
(
  1,
  'serin',
